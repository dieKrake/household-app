...
export default function Page() {
  return (
    <main className="relative overflow-hidden">
      {/* Logo Container */}
      <div className="bg-oceanSemiDark dark:bg-gray-900 absolute top-0 left-0 right-0 z-10 pt-4 pb-4 pl-2 sm:pt-6 sm:pb-6 sm:pl-5">
        <AcmeLogo />
      </div>
      ...
      <div className="flex min-h-screen">
        ...
        <div className="bg-gray-200 dark:bg-oceanSemiDark flex flex-none flex-col justify-center items-center sm:w-96 w-36 px-4 sm:px-0">
        ...
        {/* Bild Container */}
        <div className="flex justify-center items-center flex-1 dark:bg-oceanSemiDark bg-gray-200">
          <Image
